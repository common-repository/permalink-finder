<?php
/*
Plugin Name: Link Fixer
Plugin URI: https://www.kpgraham.com
Description: Never get a 404 page not found again. If you have restructured or moved your blog, this plugin will find the right post or page every time (The name has been changed from Permalink Finder to Link Fixer).
Version: 3.4
...
function kpg_pf_admin_menus() {
	...
	add_options_page('Link Fixer', 'Link Fixer', 'manage_options', 'Link_fixer','kpg_permalink_finder_control');
...
function kpg_pf_net_admin_menus() {
	...
	add_submenu_page('settings.php','Link Fixer', 'Link Fixer', 'manage_network_options', 'adminpermalink_finder','kpg_permalink_finder_control');
...
function kpg_pf_rightnow() {
	...
	if ($totredir>0) {
		...
		echo "<p><a style=\"font-style:italic;\" href=\"$me\">Link Fixer</a> has redirected $totredir pages.";
		...
		echo "<p><a style=\"font-style:italic\" href=\"$me\">Link Fixer</a> has not redirected any 404 errors, yet.";
		echo"</p>";
	}
}
